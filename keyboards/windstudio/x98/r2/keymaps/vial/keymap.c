...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KC_GRV,  KC_1,    KC_2,    KC_3,   KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,  KC_EQL,  KC_BSLS, KC_BSPC, KC_PGUP, KC_NUM,  KC_PSLS, KC_PAST, KC_PMNS,
	...
	[1] = LAYOUT(
	_______,          _______, _______, CAPSLKD, CAPSLKU, COMBLKD, COMBLKU, NUMLKOD, NUMLKOU, _______, _______, _______,          _______, _______, _______, _______, _______, _______,
	...
	MO(2),   _______, _______,                            _______,                            _______, _______, _______,          _______, _______, UG_TOGG,          _______
    ),

	[2] = LAYOUT(
	EE_CLR,           _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, QK_BOOT, _______, _______, _______, _______,
	_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
